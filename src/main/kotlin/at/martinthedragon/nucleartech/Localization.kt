...
object LangKeys {
    ...
    const val CAT_SUBTITLE = "subtitle"
    ...
    val DEVICE_METEOR_REMOTE_WATCH_OUT = of(CAT_DEVICE, "meteor_remote.watch_out")
    ...
    val SUBTITLE_ANVIL_FALL = of(CAT_SUBTITLE, "anvil.fall")
    val SUBTITLE_ASSEMBLER_OPERATE = of(CAT_SUBTITLE, "assembler.operate")
    val SUBTITLE_BLEEP = of(CAT_SUBTITLE, "bleep")
    val SUBTITLE_BLOCK_DEBRIS = of(CAT_SUBTITLE, "block.debris")
    val SUBTITLE_BOOP = of(CAT_SUBTITLE, "boop")
    val SUBTITLE_CENTRIFUGE_OPERATE = of(CAT_SUBTITLE, "centrifuge.operate")
    val SUBTITLE_CHEM_PLANT_OPERATE = of(CAT_SUBTITLE, "chem_plant.operate")
    val SUBTITLE_GEIGER_CLICK = of(CAT_SUBTITLE, "geiger.click")
    val SUBTITLE_ITEM_INJECT = of(CAT_SUBTITLE, "item.inject")
    val SUBTITLE_ITEM_UNPACK = of(CAT_SUBTITLE, "item.unpack")
    val SUBTITLE_METEOR_IMPACT = of(CAT_SUBTITLE, "entity.meteor.impact")
    val SUBTITLE_MINI_NUKE_EXPLODE = of(CAT_SUBTITLE, "mini_nuke.explode")
    val SUBTITLE_MISSILE_TAKEOFF = of(CAT_SUBTITLE, "missile.takeoff")
    val SUBTITLE_PRESS_OPERATE = of(CAT_SUBTITLE, "press.operate")
    val SUBTITLE_RBMK_AZ5_COVER = of(CAT_SUBTITLE, "rbmk.az5_cover")
    val SUBTITLE_RBMK_EXPLODE = of(CAT_SUBTITLE, "rbmk.explode")
    val SUBTITLE_RBMK_SHUTDOWN = of(CAT_SUBTITLE, "rbmk.shutdown")
    val SUBTITLE_SIREN_AIR_RAID = of(CAT_SUBTITLE, "siren.air_raid")
    val SUBTITLE_SIREN_AMS = of(CAT_SUBTITLE, "siren.ams")
    val SUBTITLE_SIREN_APC = of(CAT_SUBTITLE, "siren.apc")
    val SUBTITLE_SIREN_APC_PASS = of(CAT_SUBTITLE, "siren.apc_pass")
    val SUBTITLE_SIREN_AUTOPILOT_DISCONNECTED = of(CAT_SUBTITLE, "siren.autopilot_disconnected")
    val SUBTITLE_SIREN_BANK = of(CAT_SUBTITLE, "siren.bank")
    val SUBTITLE_SIREN_BEEP = of(CAT_SUBTITLE, "siren.beep")
    val SUBTITLE_SIREN_BLAST_DOOR = of(CAT_SUBTITLE, "siren.blast_door")
    val SUBTITLE_SIREN_CLASSIC = of(CAT_SUBTITLE, "siren.classic")
    val SUBTITLE_SIREN_CONTAINER = of(CAT_SUBTITLE, "siren.container")
    val SUBTITLE_SIREN_EAS = of(CAT_SUBTITLE, "siren.eas")
    val SUBTITLE_SIREN_HATCH = of(CAT_SUBTITLE, "siren.hatch")
    val SUBTITLE_SIREN_KLAXON = of(CAT_SUBTITLE, "siren.klaxon")
    val SUBTITLE_SIREN_MISSILE_SILO = of(CAT_SUBTITLE, "siren.missile_silo")
    val SUBTITLE_SIREN_NOSTROMO_SELF_DESTRUCT = of(CAT_SUBTITLE, "siren.nostromo_self_destruct")
    val SUBTITLE_SIREN_RAZORTRAIN_HORN = of(CAT_SUBTITLE, "siren.razortrain_horn")
    val SUBTITLE_SIREN_SECURITY = of(CAT_SUBTITLE, "siren.security")
    val SUBTITLE_SIREN_STANDARD = of(CAT_SUBTITLE, "siren.standard")
    val SUBTITLE_SIREN_SWEEP = of(CAT_SUBTITLE, "siren.sweep")
    val SUBTITLE_SIREN_VAULT_DOOR = of(CAT_SUBTITLE, "siren.vault_door")
    val SUBTITLE_UPGRADE_INSTALL = of(CAT_SUBTITLE, "upgrade.install")
    val SUBTITLE_USE_RADAWAY = of(CAT_SUBTITLE, "radaway.use")
